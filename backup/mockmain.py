...
async def main():
    ...
    cfg_q = Queue(maxsize=1)
    nav_q = Queue(maxsize=1)
    ...
    rtcmon = await GnssHandler.set_rtcm_status_update()
    print("rtcm status update enabled: " + str(rtcmon))
    gc.collect()
